...
<body>
  ...
  <section>
    <div class="container">
      <div class="construct">
        <img width="150px" height="150px" src="./assert/image/construct.png" alt="construct">
        <h2 class="construct__title">Раздел находиться в разработке</h2>
        <h4>Вернитесь позже!</h4>
      </div>
    </div>
  </section>
