...
<body>
    ...
    <div class="container">
        <form action="" method="post" class="form__column form__border update__product">
            <div class="form__point">
                <label class="form__title" for="">Наименование</label>
                <input class="form__field field_long" name="title" type="text" value="<?= $prod->title ?>" placeholder="Наименование">
            </div>
            <div class="form__box">
                <div class="form__point">
                    <label class="form__title" for="">Цена</label>
                    <input class="form__field field_min" name="price" type="text" value="<?= $prod->price ?>" placeholder="Цена, ₽">
                </div>
                <div class="form__point">
                    <label class="form__title" for="">Скидка</label>
                    <input class="form__field field_min" name="sale" type="text" value="<?= $prod->sale ?>" placeholder="Скидка, ₽">
                </div>
            </div>
            <div class="form__box">
                <div class="form__point">
                    <label class="form__title" for="">Вес</label>
                    <input class="form__field field_min" name="weight" type="text" value="<?= $prod->weight ?>" placeholder="Вес">
                </div>
                <div class="form__point">
                    <label class="form__title" for="">Единица</label>
                    <select class="form__field field__select" name="weight__value" id="selectItem">
            ...
            <div class="form__point">
                ...
                <input class="form__field field_long" name="image" type="text" value="<?= $prod->image ?>" placeholder=".\assert\image\products">
            </div>
            <div class="form__point">
                <label class="form__title" for="">Описание</label>
                <textarea class="form__field field_text" rows="5" name="description" type="text" placeholder="Описание"><?= $prod->description ?></textarea>
            </div>
            <div class="block__btn">
                <input type="submit" class="btn input__btn" value="Обновить">
            </div>
        </form>
    </div>
    ...
    <script src="./assert/js/update.js"></script>
</body>
