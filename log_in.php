...
<body>
  ...
  <section>
    <div class="container">
      <div class="registr">
        <div class="block__btn registration__input">
          <div class="registration__">
            <form action="/API/log_in.php" class="registr__form">
              ...
              <div class="form__point not__margin">
              ...
              <input class="btn input__btn" type="submit" value="Войти">
            </form>
            <p class="registr__pass-txt">Нет аккаунта?</p>
            <a class="registr__password" href="registr.php">Зарегистрироваться </a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="./assert/js/log_in.js"></script>
</body>
